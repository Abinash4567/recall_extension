            ...
            // setInterval(() => {
                ...
                for (let i = 0; i < arrYCoordinates.length - 1; i++) {
                    ...
                    if (check)
                    {
                        ...
                        let avatarImage = "https://res.cloudinary.com/dxh7ycus9/image/upload/v1718447029/recall/ayoub-moukhliss-423_q0prsi.jpg";
                        let username = "Abinash";
                        let time = "2024-06-15T10:23:52.778Z".slice(0, 10);
                        let image = "https://res.cloudinary.com/dxh7ycus9/image/upload/v1718447030/recall/free-photo-of-a-man-standing-in-front-of-a-garage-door_au0q4z.jpg";
                        let tweet = "This is my first tweet";
                        let usernameHandle = "skanc";
